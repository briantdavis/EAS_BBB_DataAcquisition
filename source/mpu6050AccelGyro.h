...
#define MPU6050_AD0_H_ADDR	0x69
#define MPU6050_AD0_L_ADDR	0x68
...
private:
  ...
  int16_t  rawAccel_X_data, rawAccel_Y_data, rawAccel_Z_data;
  int16_t  rawTemp_data;
  int16_t  rawGyro_X_data, rawGyro_Y_data, rawGyro_Z_data;
...
public:
 ...
 //
 	...
 	MPU6050AccelGyro(int, int);
 	virtual ~MPU6050AccelGyro();
  
  //
  // Mutator
  int init_device();
	int updateAccelGyroTempData();
  //
  // Utility Fn
